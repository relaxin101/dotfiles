...
#####################################
# setup thefuck for "fuck" command
#####################################

eval $(thefuck --alias)

#####################################
#setup fuzzy file find
#####################################
...
zstyle ':fzf-tab:complete:z:*' fzf-preview 'eza --tree --level 2 --color=always $realpath | head -200'
zstyle ':fzf-tab:complete:nvim:*' fzf-preview 'eza --tree --level 2 --color=always $realpath | head -200'
